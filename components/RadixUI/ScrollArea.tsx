    ...
    return (
        ...
        >
            ...
            <ScrollAreaPrimitive.Scrollbar
                className="flex touch-none select-none p-0.5 transition-colors duration-[160ms] ease-out hover:bg-accent data-[orientation=horizontal]:h-2.5 data-[orientation=vertical]:w-2.5 data-[orientation=horizontal]:flex-col"
            ...
            {fadeHeight > 0 && !websiteMode && (
                <div
                    className={`scrollarea-fade absolute bottom-0 left-0 right-0 h-${fadeHeight} bg-gradient-to-b from-transparent to-[rgb(var(--bg))]`}
                />
            )}
        </ScrollAreaPrimitive.Root>
    )
