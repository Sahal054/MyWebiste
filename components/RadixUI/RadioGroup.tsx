...
const radioGroupIndicatorOuterClasses = 'inline-block w-5 h-5 rounded-full border border-primary group-hover:border-primary flex items-center justify-center bg-primary'
const radioGroupIndicatorInnerClasses = 'w-3 h-3 rounded-full block bg-primary border-primary'
